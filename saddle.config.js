  ...
  networks: {                                               // Define configuration for each network
    ...
    goerli: {
      providers: [
        ...
        {http: "https://goerli-eth.rikkei.finance"}
      ],
      web3: {
        gas: [
          {env: "GAS"},
    ...
    ropsten: {
      providers: [
        ...
        {http: "https://ropsten-eth.rikkei.finance"}
      ],
      web3: {
        gas: [
          {env: "GAS"},
    ...
    rinkeby: {
      providers: [
        ...
        {http: "https://rinkeby-eth.rikkei.finance"}
      ],
      web3: {
        gas: [
          {env: "GAS"},
    ...
    kovan: {
      providers: [
        ...
        {http: "https://kovan-eth.rikkei.finance"}
      ],
      web3: {
        gas: [
          {env: "GAS"},
    ...
    mainnet: {
      providers: [
        ...
        {http: "https://mainnet-eth.rikkei.finance"}
      ],
      web3: {
        gas: [
          {env: "GAS"},
