...
const { CointrollerErr, TokenErr, IRErr, MathErr } = require('./Errors');
...
expect.extend({
  ...
  toHaveTrollError(actual, expectedErrorName) {
    return hasError.call(this, actual, expectedErrorName, CointrollerErr);
  },
  ...
  toHaveTrollFailure(result, err, info, detail=undefined) {
    return hasFailure.call(this, result, err, info, detail, CointrollerErr, 'toHaveTrollFailure');
  },
  ...
  toHaveTrollReject(result, info, detail) {
    return hasFailure.call(this, result, 'COINTROLLER_REJECTION', info, detail && CointrollerErr.Error[detail], TokenErr, 'toHaveTrollReject');
  },

  toHaveTrollErrorTuple(result, tuple, cmp=undefined) {
    return hasErrorTuple.call(this, result, tuple, CointrollerErr, cmp);
  },
