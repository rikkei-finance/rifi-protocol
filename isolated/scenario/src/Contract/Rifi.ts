...
export interface RifiScenarioMethods extends RifiMethods {
...
export interface Rifi extends Contract {
  methods: RifiMethods;
  name: string;
}

export interface RifiScenario extends Contract {
  methods: RifiScenarioMethods;
  name: string;
}
